...
st.text('I led a project with the marketing analytics team to analyze social media habits in the US, specifically focusing on LinkedIn usage. The goal was to build a real-time predictive model based on individual attributes and demographics. This interactive application, publicly hosted, empowers our marketing team to strategically target platforms and identify key customer segments for effective campaigns. The project aligns with our commitment to data-driven decision-making and innovative marketing strategies.', divider='rainbow')
